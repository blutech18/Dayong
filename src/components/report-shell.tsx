      ...
      <div className="mx-auto max-w-4xl bg-white text-slate-900 shadow-lg print:shadow-none print:max-w-none">
        ...
        <div className="p-8">
          ...
          <div className="mt-10 grid grid-cols-2 gap-8">
            <div>
              <div className="border-b border-slate-400 pb-1 text-center text-sm font-medium">{preparedBy}</div>
              <div className="mt-1 text-center text-xs text-slate-600">Prepared by · {preparedRole}</div>
            </div>
            <div>
...
export function ReportTile({ label, value, tone = "primary" }: { label: string; value: string; tone?: "emerald" | "rose" | "primary" | "amber" | "sky" }) {
  const cls = {
