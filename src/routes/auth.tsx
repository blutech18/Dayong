    ...
    <div className="relative flex min-h-screen">
      ...
      <div className="absolute inset-y-0 right-0 hidden w-full lg:block lg:w-[60%]">
        <div className="relative h-full w-full">
          ...
          {/* Text Overlay */}
          <div className="absolute inset-0 flex flex-col justify-between p-12 pl-[15%] text-white">
      ...
      {/* Left side - Content with gradient fade on desktop */}
      <div className="relative z-10 flex min-h-screen w-full flex-col bg-background px-6 py-10 sm:px-10 lg:w-[50%] lg:bg-transparent lg:bg-gradient-to-r lg:from-background lg:from-[75%] lg:to-background/0 xl:w-[45%] xl:from-[65%]">
