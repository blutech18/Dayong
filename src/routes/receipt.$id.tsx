...
export const Route = createFileRoute("/receipt/$id")({
  ...
  notFoundComponent: () => (
    <div className="p-8 text-center text-sm text-muted-foreground">Receipt not found.</div>
  ),
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-slate-500">
                  Barangay San Roque · Quezon City · Metro Manila
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 gap-6 border-b border-slate-200 pb-6">
            ...
            <div className="text-right">
              ...
              <div className="text-sm text-slate-600">
                Status: <span className="font-medium capitalize">{receipt.status}</span>
              </div>
            </div>
          </div>
